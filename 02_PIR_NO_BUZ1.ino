/*
  ...
  Ino File: 02_PIR_NO_BUZ1.ino
  link: https://rainmaker.espressif.com/docs/get-started.html

   Objective: 
      
      This example demonstrates the ESP RainMaker integration 
      with a standard Motion Sensor device using an ESP32.
      This is the node that sends information to the mobile device to launch the drone. 
      Code for Docs/fritz/PIR NO BUZZER.fzz - BUZZER PIR#3
