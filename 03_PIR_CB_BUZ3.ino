/*
  ...
  Ino File: 03_PIR_CB_BUZ3.ino
  link: https://rainmaker.espressif.com/docs/get-started.html

   Objective: 
      
   This example demonstrates the integration of ESP RainMaker 
   with a standard motion sensor device using an ESP32. 
   This node sends information to the mobile device 
   to trigger notifications using callbacks.  
   Code for Docs/fritz/PIR CALLBACK BUZZER_bb.png - BUZZER PIR#1 & PIR#2
